/**
 * Build the akx executables and development Node carrier for the Python runtime wheel. The fixed
...
const DEPLOY_ROOT_PACKAGE = 'akx-python-runtime-closure'
...
const OUTPUT_BASENAME = 'akx-harness-sdk-runtime'
/** Default Node major; SEA mode requires at least Node 22. */
const DEFAULT_NODE_RANGE = 'node24'
const OUT_DIR = 'dist-exe'
/** Python package destination; created when absent. */
const PYTHON_RUNTIME_DIR = 'python/sdk-runtime/src/akx_harness_runtime/runtime'
...
const ASSET_GLOBS = [
  ...
  'node_modules/@akashx/akx-web-frontend/dist/**/*',
  // skill-badge resolves both Markdown and image resources through import.meta.url.
  'node_modules/@akashx/akx-skill-badge/assets/**/*',
]
