...
import type { CordisCatalogModel, ServiceMethodEntry } from '@akashx/akx-typert-generator'
...
function main(): void {
  ...
  const source = projector.renderRuntimeApi(clientModel(model))
    ...
    .replaceAll('@akashx/akx-tool-cordis/api-catalog', '@akashx/akx-cordis-client-runner/client/api-catalog')
