...
import {
  ...
  REGION_BEGIN,
  REGION_END,
} from '@akashx/akx-typert-generator'
import type { CordisCatalogPolicy } from '@akashx/akx-typert-generator'
...
export const SERVICE_PAGE: Record<string, string> = {
  ...
  akashxLlmApiExtensions: 'llm-streaming.md',
 ...
 * The scan that enforces this list reads EVERY `declare module '@akashx/cordis'`
...
export const SERVICE_WALK_EXEMPTIONS: Record<string, string> = {
  ...
  akxHomePath: 'not a service: boot-provided root accessor function (typeof akxHomePath | undefined) for Loader !!js config expressions — packages/boot/app-boot/README.md owns the boot contract',
 ...
 * scan reads EVERY `declare module '@akashx/cordis'` Events merge under
...
export const LINK_MAP: Readonly<Record<string, string>> = {
  ...
  AkashXLlmApiExtensionMap: 'llm-streaming.md',
  AkashXLlmApiExtensionProvider: 'llm-streaming.md',
  AkashXLlmApiExtensionRequest: 'llm-streaming.md',
  ...
  PreparedAkashXLlmApiExtensions: 'llm-streaming.md',
