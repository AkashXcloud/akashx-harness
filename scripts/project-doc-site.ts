...
const REPOSITORY_URL = 'https://github.com/akashx-ai/akx-harness'
...
function githubTarget(
  ...
  if (image) return `https://raw.githubusercontent.com/akashx-ai/akx-harness/${repositoryRef}/${path}${suffix}`
