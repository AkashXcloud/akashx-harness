...
import type { ChatSnapshot } from '@akashx/akx-client-ui-chat/client'
...
assertBuiltBenchmarkRuntime(import.meta.url, {
  '@akashx/akx-client-store': import.meta.resolve('@akashx/akx-client-store'),
  '@akashx/akx-llm/assistant-stream': import.meta.resolve('@akashx/akx-llm/assistant-stream'),
  '@akashx/akx-session/surface': import.meta.resolve('@akashx/akx-session/surface'),
  '@akashx/akx-token-meter/client': import.meta.resolve('@akashx/akx-token-meter/client'),
})
