...
import { parseSessionLog } from '@akashx/akx-llm-replay'
import type { SessionEvent, SessionId } from '@akashx/akx-session'
import type {} from '@akashx/akx-goal'
import {
...
const PACKAGE_FILES: Readonly<Record<string, string>> = {
  ...
  'packages/client/ui-conversation/package.json': '{"name":"@akashx/akx-client-ui-conversation"}\n',
  ...
  'packages/context/session-reference/package.json': '{"name":"@akashx/akx-session-reference"}\n',
  ...
  'packages/llm/token-meter/package.json': '{"name":"@akashx/akx-token-meter"}\n',
  ...
  'packages/skill/skill-filesystem/package.json': '{"name":"@akashx/akx-skill-filesystem"}\n',
