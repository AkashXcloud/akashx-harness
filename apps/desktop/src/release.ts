/** Immutable version identity shared by one Electron shell and its bundled akx runtime. */
...
export interface DesktopRelease {
  ...
  /** Exact version used by both Electron and `@akashx/akx`. */
...
export function parseDesktopRelease(value: unknown): DesktopRelease {
  if (!isRecord(value) || value.schemaVersion !== 1 || typeof value.version !== 'string'
    ...
    throw new Error('akx desktop: invalid desktop release metadata')
  }
  return {
    schemaVersion: 1,
