...
export const en = {
  ...
  startupFailed: 'AkashX Harness could not start',
  startupLoading: 'Starting AkashX Harness…',
  ...
  updateTitle: 'AkashX Harness Update',
  updateAvailable: 'An update is available',
  updateDetail: 'AkashX Harness {version}\n\nThis release includes its matching akx version. The application will restart after installation.',
  installAndRestart: 'Install and Restart',
  later: 'Later',
  updateFailedTitle: 'Update Failed',
  pluginManagerTitle: 'Desktop Plugins',
  pluginWindowTitle: 'AkashX Harness — Desktop Plugins',
...
export const zh = {
  application: '应用',
  startupFailed: 'AkashX Harness 无法启动',
  startupLoading: '正在启动 AkashX Harness…',
  ...
  updateTitle: 'AkashX Harness 更新',
  updateAvailable: '发现可用更新',
  updateDetail: 'AkashX Harness {version}\n\n新版本绑定匹配的 akx，安装后将重新启动。',
  installAndRestart: '安装并重启',
  later: '稍后',
  updateFailedTitle: '更新失败',
  pluginManagerTitle: '桌面插件',
  pluginWindowTitle: 'AkashX Harness — 桌面插件',
