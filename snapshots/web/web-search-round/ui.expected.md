...
- button "System prompt":
  ...
  - img
  - text: System prompt
- text: Use web_search once with queries ["AkashX Harness snapshot search","AkashX Harness multi-query search"]. Then reply exactly SEARCH_DONE and stop. {{clock}}
- button "Copy":
  - img
...
- button "Search AkashX Harness snapshot search, AkashX Harness multi-query search":
  - img
  - img
  - text: Search AkashX Harness snapshot search, AkashX Harness multi-query search
