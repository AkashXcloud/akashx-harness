...
- **A thin workflow skill, contracts in docs.** [.agents/skills/akx-doc](../../../skills/akx-doc/SKILL.md) carries the placement, audit, budget, and website workflow and defers to the standard as its source of truth, the same split as [akx-translate-docs](../../../skills/akx-translate-docs/SKILL.md) over the i18n contract.
