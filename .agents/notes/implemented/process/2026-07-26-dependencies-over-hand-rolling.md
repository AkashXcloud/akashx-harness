...
- Agents and contributors surveying for simplifications now treat "replace hand-rolled X with package Y" as in-scope output; [akx-find-simplifications](../../../skills/akx-find-simplifications/SKILL.md) carries the corresponding guidance.
