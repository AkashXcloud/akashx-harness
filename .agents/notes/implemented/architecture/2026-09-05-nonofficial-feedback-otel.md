...
The [canonical-feedback decision](2026-09-05-canonical-feedback-log.md) owns storage, versions, deletion, and plain command confirmation. The [opt-in AkashX contribution](../../../../packages/session/session-log-akx/README.md) remains independent, with its existing destination and acceptance behavior.
