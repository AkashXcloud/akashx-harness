import { EntryGroup, EntryTree, isJsExpr, type EntryOptions } from '@akashx/cordis-plugin-loader'
 ...
 * (`akx --dump-config`) parses and prints exactly the dialect this include
 * mounts.
 */
 ...
 * (`akx --dump-config`) so a dump can never drift from what boots. The input
