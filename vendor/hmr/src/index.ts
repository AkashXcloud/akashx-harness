import { Context, Service, type Plugin } from '@akashx/cordis'
import type { Dict } from '@akashx/cosmokit'
import { ModuleLoader, type ModuleJob, type ResolveResult } from '@akashx/cordis-plugin-loader'
import type { Include } from '@akashx/cordis-plugin-include'
import { FSWatcher, watch, type ChokidarOptions } from 'chokidar'
import { dirname, relative, resolve } from 'node:path'
import { realpath, stat } from 'node:fs/promises'
import { handleError } from './error.ts'
import type {} from '@akashx/cordis-plugin-timer'
...
namespace Hmr {
  ...
  // [akx-harness] vendored modification: removed `.i18n({ 'en-US': enUS, 'zh-CN': zhCN })`
