 ...
 *
 * @module @akashx/akx-sandbox-local/profiles
 */

import { grantArgs as landlockGrantArgs } from '@akashx/node-addon-system/landlock-run'
 ...
 * (`@akashx/akx-fs-sandbox`) can never drift apart.
