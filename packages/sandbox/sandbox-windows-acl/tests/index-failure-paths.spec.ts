...
import { ERROR_BROKEN_PIPE } from '@akashx/akx-win32-process/src/abi.ts'
import { PROCESS_INFORMATION } from '@akashx/akx-win32-process/src/ffi.ts'
...
function scratch(): string {
  const dir = mkdtempSync(join(tmpdir(), 'akx-acl-index-'))
