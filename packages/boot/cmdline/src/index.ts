/**
 * @akashx/akx-cmdline — the command line a akx launcher hands to the app
 * it boots.
 *
 ...
 * verbatim and in argv order. `akx --profile tui --resume abc` yields
 * `['--resume', 'abc']`.
 */
