...
import type { EntryInfo, Sandbox } from '@akashx/akx-e2b'

const VERSION_METADATA_KEY = 'akx-version'
...
export class E2BFileSystem extends FileSystem {
  ...
  private async writeAtomic(
    ...
    const stagingDirectory = posix.join(posix.dirname(targetPath), `.akx-${randomUUID()}.tmp`)
