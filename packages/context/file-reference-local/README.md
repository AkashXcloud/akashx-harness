...
```yaml
- name: '@akashx/akx-file-reference-local'
  config:
    maxResults: 20
```
...
- [Filesystem tool catalog](../../../docs/tool-catalog.md#akashx-akx-tool-fs) — the `read` tool whose namespace discovery must match.
