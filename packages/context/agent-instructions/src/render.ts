 ...
 *
 * @module @akashx/akx-agent-instructions/render
 */
...
/**
 * File name of the single user-global instruction file under `$AKX_HOME`.
 * Discovery (`$AKX_HOME/<name>`) and reconciliation (the user-global scope key's
...
export function scopeForDisplayPath(displayPath: string): string {
  if (displayPath === '~/.akx/AGENTS.md' || displayPath === '$AKX_HOME/AGENTS.md') return USER_GLOBAL_DIRECTORY
