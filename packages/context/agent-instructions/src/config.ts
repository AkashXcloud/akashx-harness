 ...
 *
 * @module @akashx/akx-agent-instructions/config
 */
...
export function resolveDiscoveryConfig(
  config: Pick<Config, 'akxHome' | 'projectRootMarkers' | 'instructionFileCandidates' | 'localInstructionFileCandidates'>,
): ResolvedDiscoveryConfig {
  return {
    akxHome: resolveAkxHome(config.akxHome),
