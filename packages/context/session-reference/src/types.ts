 ...
 * @module @akashx/akx-session-reference/types
 */

import type { UserMessage } from '@akashx/akx-llm/message'
import type { ContentBlock } from '@akashx/akx-llm/types'
import type { OptionalSessionSeq, SessionId } from '@akashx/akx-session/types'
...
export interface SessionReferenceMentionCandidate extends SessionReferenceCandidate {
  /** Canonical `@[label](akx-session:…)` mention serialized into the prompt draft. */
  mention: string
}
