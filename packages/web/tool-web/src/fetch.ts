...
import type { GenericCallView, ToolResult, WebFetchResultView } from '@akashx/akx-tools'
import type { WebFetchBody, WebFetchResult } from '@akashx/akx-web'
import { assertNever, type JsonValue } from '@akashx/akx-util-values'
 ...
 * `@akashx/akx-tool-call-timeout-policy`, not a model argument.
 *
 ...
 *   `ToolDefinition.timeoutMs` for `@akashx/akx-tool-call-timeout-policy` to enforce.
