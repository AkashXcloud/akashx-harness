/**
 * Provider-private wire types for AkashX's Anthropic-compatible Messages API. Citeable
 ...
 * @module @akashx/akx-web-search-akx/types
 */
...
/** AkashX's Anthropic Messages response envelope. */
export interface AnthropicResponse {
  content?: ContentBlock[]
}

/** AkashX's error response envelope (best-effort; fields vary). */
