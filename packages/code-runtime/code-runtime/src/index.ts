 ...
 * @module @akashx/akx-code-runtime
 */
 ...
 * `__akx_main__`/`__builtins__`/`__name__` (the Python backend's bootstrap
...
export const RESERVED_BINDING_GLOBALS: ReadonlySet<string> = new Set([
  'console',
  '__akx_main__', '__builtins__', '__name__', '__debug__',
])
...
export abstract class CodeRuntime extends Service {
   ...
   * `akx-tools` presents; the TypeScript backend is released, the Python
