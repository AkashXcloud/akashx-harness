...
import type { Config } from '@akashx/akx-code-runtime-worker-thread'
import type { CodeBindingFunction, CodeBindingNamespace, CodeRunResult } from '@akashx/akx-code-runtime'
...
describe('WorkerThreadCodeRuntime — seam misuse and lifecycle', () => {
  ...
  it('rejects malformed or colliding binding error-class declarations', async () => {
    ...
    await expect(runtime.run({ program: 'return 1', bindings: [{ global: '__akx_main__', functions: {} }] }))
