/** JSON string-prefix accounting for the outer-output ledger. @module @akashx/akx-code-runtime-worker-thread/output-json */

import type { CodeJsonValue } from '@akashx/akx-code-runtime'
