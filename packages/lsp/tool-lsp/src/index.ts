 ...
 * `akx-tool-call-timeout-policy` to enforce. It runtime-injects only `tools`, `lsp`, and `systemPrompt` and
 * imports no provider.
 *
 * Namespace plugin (named exports, no default export).
 * @module @akashx/akx-tool-lsp
 */

import type { Context } from '@akashx/cordis'
import z from '@akashx/schemastery'
import { defineTool } from '@akashx/akx-tools'
import { LspError } from '@akashx/akx-lsp'
import type {} from '@akashx/akx-lsp'
