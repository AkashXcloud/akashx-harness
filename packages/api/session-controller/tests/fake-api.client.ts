...
import type { WorkspaceRemote } from '@akashx/akx-api-workspace-controller/client'
import type { WorkspaceFollowFrame } from '@akashx/akx-api-workspace-controller/types'
