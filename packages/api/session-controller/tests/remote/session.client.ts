 ...
 */
import { AttachmentId, type FileAttachmentRef, type ImageAttachmentRef } from '@akashx/akx-attachment'
import type { ContentBlock } from '@akashx/akx-llm/types'
import type { MessageId } from '@akashx/akx-llm/brand'
import { ok, type RemoteMock, type RemoteTable, type StreamScript, type UnaryRuleFn } from '@akashx/akx-remote-mock'
