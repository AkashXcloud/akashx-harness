 ...
 */
import type { Context, Fiber } from '@akashx/cordis'
...
import { workspaceTitleOf } from '@akashx/akx-util-workspace-path'
...
// akx-scope, keyed by Agent identity); re-exported here so existing
...
export class ClientSessions implements ISessions {
  ...
  constructor(
    ...
    this.selection = createSnapshotStore<SessionSelection>(
      {},
      { persist: { name: 'akx.sessions.current' } })
