 ...
 * Agent's identity. The mechanism mirrors the host `akx-scope` architecture
...
import type { TypertRemoteScopeApi } from '@akashx/akx-typert-protocol'
...
const kScope = Symbol('akx.client.scope')
