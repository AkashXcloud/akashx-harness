...
import { z } from 'zod'
import { DirectoryPickerError } from '@akashx/akx-host-directory-picker'
import type {
  DirectoryPickerCapabilities, DirectoryPickerErrorCode,
} from '@akashx/akx-host-directory-picker'
...
import type { RemoteErrorCode } from '@akashx/akx-typert-protocol'
