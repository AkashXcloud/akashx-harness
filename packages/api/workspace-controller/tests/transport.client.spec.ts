...
import { RemoteStreamCarrierError, type ClientRemote } from '@akashx/akx-api-gateway/client'
import { SessionId } from '@akashx/akx-session/types'
import { RemoteError } from '@akashx/akx-typert-protocol'
import { frames, openStream, type RemoteMock, type StreamScript } from '@akashx/akx-remote-mock'
...
const SELF = '@akashx/akx-api-workspace-controller'
