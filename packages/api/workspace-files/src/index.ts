...
import type { FsDirEntry, FsInfo, FsPathInfo, FsTarget } from '@akashx/akx-fs'
...
import { Remote, RemoteError, TypertRemoteService, type TypertLookup } from '@akashx/akx-typert-protocol'
  ...
  constructor(ctx: Context, private readonly config: Config) {
    ...
    ctx.inject(['sessions', 'typert'], (scope) => {
      scope.typert.lookups.register('workspaceFileScope', {
        ...
        hostTypeSymbol: '@akashx/akx-api-workspace-files#WorkspaceFileScope',
 ...
 * belongs to whichever `akx-fs` instance the provider loaded, so no class
