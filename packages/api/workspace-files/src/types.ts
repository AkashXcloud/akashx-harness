 ...
 *   resource system, whose `akx-resource://file/session/<id>/<path>` address carries that
 *   same path.
 ...
 *
 * @module @akashx/akx-api-workspace-files/types
 */
...
import type {} from '@akashx/akx-typert-protocol'
...
export interface WorkspaceFileStat {
   ...
   * on Windows. What a `akx-resource://file/absolute/…` address carries, and
   * what a `akx-resource://file/session/<sessionId>/…` address's
