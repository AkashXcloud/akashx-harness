...
The generated [configuration catalog](../../../docs/config-catalog.md#akashxakx-headless) is the exhaustive source for every accepted field and its JSDoc.
...
- [Generated configuration catalog](../../../docs/config-catalog.md#akashxakx-headless) — every accepted config field and its source declaration.
