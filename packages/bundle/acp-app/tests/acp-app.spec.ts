...
describe('akx-acp-app bundle', () => {
  it('declares startup-gated ACP serving without overriding base HMR policy', () => {
    ...
    expect(manifest.dependencies).toHaveProperty('@akashx/akx-acp')
    ...
    expect(rows.find(row => row.id === 'acp-app-startup')?.name).toBe('@akashx/akx-acp-app')
