 ...
 * @module @akashx/akx-agent-presets/discovery
 */
...
import { expandHomePath } from '@akashx/akx-home-paths'
 ...
 *
 * This package owns the writable root the way `akx-skill-filesystem` owns
 * `<akxHome>/skills`: where a person's own presets go is the same place in
