 ...
 * @module @akashx/akx-agent-presets/composition-inventory
 */

import { readFile } from 'node:fs/promises'
import { load } from 'js-yaml'
import type { FiberState } from '@akashx/cordis'
import { isJsExpr, type EntryTree } from '@akashx/cordis-plugin-loader'
