/**
 * Package-owned invariant companion for `@akashx/akx-agent-presets`.
 * @module @akashx/akx-agent-presets/invariant
 */
...
// joins, and the `agent` field `akx-agent` merges into its context.
...
import { leakedServices, livePresetMounts } from '@akashx/akx-agent-presets'

const PACKAGE_NAME = '@akashx/akx-agent-presets'
