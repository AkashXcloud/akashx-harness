...
- [SDK application bundle](../bundle/sdk-app/README.md) — the `akx --profile sdk` application that boots the JSON-RPC server.
...
- [SDK subagent provider](../subagent/subagent-akx-sdk/README.md) — a harness-internal consumer of the TypeScript client.
