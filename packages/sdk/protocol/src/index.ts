/**
 * Shared wire protocol for the AkashX Harness SDK runtime: the
 ...
 * (`@akashx/akx-sdk-jsonrpc-server`) serves this protocol; SDK clients
 * (`@akashx/akx-sdk-client`, the Python SDK) drive it.
 *
 * @module @akashx/akx-sdk-protocol
 */
