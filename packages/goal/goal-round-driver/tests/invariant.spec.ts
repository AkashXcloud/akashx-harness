...
import * as GoalSessionInvariant from '@akashx/akx-goal-round-driver/invariant'
import { renderGoalRoundPrompt } from '@akashx/akx-goal-round-driver'
import InvariantRegistry, { InvariantError } from '@akashx/akx-invariants'
import SessionStore, { SessionId, type Session } from '@akashx/akx-session'
...
describe('goal-round-driver prompt invariants', () => {
  ...
  it('rejects a continuation whose content differs from the package renderer', async () => {
    ...
    expect(() => {
      ...
      code: 'INVARIANT',
      packageName: '@akashx/akx-goal-round-driver',
    }))
  })
