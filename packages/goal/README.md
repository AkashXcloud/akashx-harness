...
- [Generated tool catalog](../../docs/tool-catalog.md#akashx-akx-tool-goal) — the three goal-tool schemas the model receives.
- [Generated configuration catalog](../../docs/config-catalog.md#akashx-akx-goal) — every accepted config field of the goal service.
