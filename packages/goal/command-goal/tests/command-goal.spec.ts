...
import type { GoalRef } from '@akashx/akx-goal'
...
import * as commandGoal from '@akashx/akx-command-goal'
...
describe('@akashx/akx-command-goal registration', () => {
  it('registers one global command with Loader-safe exports and disposes it', async () => {
    ...
    expect(test.ctx.commands.list(test.agent)).toContainEqual({
      definitionId: '@akashx/akx-command-goal',
      name: 'goal',
