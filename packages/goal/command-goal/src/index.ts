 ...
 * @module @akashx/akx-command-goal
 */
...
import { GoalError } from '@akashx/akx-goal'
import type { GoalPhase, GoalRef, GoalView } from '@akashx/akx-goal'
...
export function apply(ctx: Context): void {
  ctx.commands.register({
    definitionId: CommandDefinitionId('@akashx/akx-command-goal'),
    name: 'goal',
