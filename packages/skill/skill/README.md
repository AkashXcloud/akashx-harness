...
The generated [configuration catalog](../../../docs/config-catalog.md#akashxakx-skill) is the exhaustive source for every accepted field.
...
- [Generated configuration catalog](../../../docs/config-catalog.md#akashxakx-skill) — every config field and its source declaration.
