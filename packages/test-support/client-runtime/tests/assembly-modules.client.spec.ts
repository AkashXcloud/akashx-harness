...
import * as modulesClient from '@akashx/akx-client-modules/client'
import { parseBootManifest } from '@akashx/akx-client-modules/client'
import type { WebBootGraph } from '@akashx/akx-client-modules/client'
import * as uiRenderer from '@akashx/akx-client-ui-renderer/client'
import * as typertRegistry from '@akashx/akx-typert-registry/client'
...
const RENDERER = '@akashx/akx-client-ui-renderer'
const TYPERT = '@akashx/akx-typert-registry'
const BRAND = '@akashx/akx-client-ui-brand-official'
const MISSING = '@akashx/akx-client-does-not-exist'
...
describe('createInProcessModules', () => {
  it('serves import() and prefetch() from registered factories and never loads a bundle', async () => {
    ...
    await expect(system.import('@akashx/akx-client-unknown', '', {})).rejects.toThrow('cannot resolve')
  })
