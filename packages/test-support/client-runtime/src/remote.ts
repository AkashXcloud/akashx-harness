...
export { RemoteError } from '@akashx/akx-typert-protocol'
...
export class TestRemote {
   ...
   */
  $host: { home: string | undefined; isLoopback: boolean; isPrivileged: boolean } = {
    home: undefined, isLoopback: true, isPrivileged: true,
  }
