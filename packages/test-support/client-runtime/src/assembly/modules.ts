 ...
 * @module @akashx/akx-client-test-runtime/src/assembly/modules
 */
import * as modulesClient from '@akashx/akx-client-modules/client'
import { createClientModuleSystem } from '@akashx/akx-client-modules/client'
import type { ClientModuleLoader, ClientModuleLoaderTarget, WebBootGraph } from '@akashx/akx-client-modules/client'
...
export const MODULES_PACKAGE = '@akashx/akx-client-modules'
 ...
 * statically imported `@akashx/akx-client-modules/client` namespace.
