...
The generated [configuration catalog](../../../docs/config-catalog.md#akashxakx-hooks-codex) is the exhaustive source for every accepted field.
...
- [Generated configuration catalog](../../../docs/config-catalog.md#akashxakx-hooks-codex) — every accepted config field and its source declaration.
