/**
 * Unit + real-load-path coverage for @akashx/akx-tool-call-timeout-policy. The
...
import { ToolCallId, HarnessError } from '@akashx/akx-llm'
import SystemPrompt from '@akashx/akx-system-prompt'
import ToolRuntime, { defineContentToolFixture, TOOL_ABORTED, type ToolExecutionInput, type PostToolDecision } from '@akashx/akx-tools'
import * as timeoutPolicy from '@akashx/akx-tool-call-timeout-policy'
import { TOOL_TIMEOUT } from '@akashx/akx-tool-call-timeout-policy'
...
describe('akx-tool-call-timeout-policy real-load-path guard', () => {
