 ...
 * `@akashx/akx-spill` storage seam. Persists oversized text to a
...
export class LocalSpillStore extends SpillStore {
   ...
   * `akx-spill-*` temp root (see {@link discoverDefaultRoots}), pruned when
  ...
  /**
   * The directory scanned for prior default `akx-spill-*` roots — the OS tmpdir,
