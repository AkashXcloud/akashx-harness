 ...
 * is `mcp__<serverName>__<rawName>`, normalized to the AkashX function-name
...
import type { AttachmentStore, ImageAttachmentRef, ImageMediaType, SaveImageAttachment } from '@akashx/akx-attachment'
import type { ContentBlock } from '@akashx/akx-llm'
import type { ToolDefinition, ToolExecution, ToolExecutionResult } from '@akashx/akx-tools'
import { assertSupportedJsonSchema } from '@akashx/akx-tools'
...
/**
 * AkashX function-name contract: at most 64 characters. Wire-protocol
 * constant, not configuration.
 */
const MAX_PUBLIC_NAME_LENGTH = 64

/** AkashX function-name contract: only `[A-Za-z0-9_-]` is allowed. */
 ...
 * truncation to the AkashX function-name contract (64 chars,
