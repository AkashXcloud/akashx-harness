...
The generated [configuration catalog](../../../docs/config-catalog.md#akashxakx-mcp-client) is the exhaustive source for every accepted field.
...
- [Generated configuration catalog](../../../docs/config-catalog.md#akashxakx-mcp-client) — every accepted config field and its source declaration.
