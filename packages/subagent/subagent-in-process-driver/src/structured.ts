 ...
 * @module @akashx/akx-subagent-in-process-driver/structured
 */

import type { Context } from '@akashx/cordis'
import type { ToolSchema } from '@akashx/akx-llm'
import type { ToolExecution, ToolRunContext } from '@akashx/akx-tools'
import { ToolArgsError, validateJsonSchemaValue, type ObjectJsonSchema } from '@akashx/akx-tools'
 ...
 *   `assertObjectJsonSchema` in akx-tools).
