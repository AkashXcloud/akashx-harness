 ...
 * @module @akashx/akx-subagent/internal
 */
...
export const adjacentAgentSendMessageTool = Symbol.for('akx.subagent.adjacentAgentSendMessageTool')
 ...
 * @internal
 */
export const deliverSubagentPrompt = Symbol.for('akx.subagent.deliverPrompt')
