...
- [Generated configuration catalog](../../../docs/config-catalog.md#akashxakx-subagent-claude-code) — every accepted config field and its source declaration.
