...
```sh
akx plugin --profile <name> add @akashx/akx-subagent-claude-code
akx plugin --profile <name> remove @akashx/akx-subagent-claude-code
akx --profile <name>
```
...
- [Generated configuration catalog](../../../docs/config-catalog.md#akashx-akx-subagent-claude-code) — every accepted config field and its source declaration.
