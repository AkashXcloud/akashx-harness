 ...
 * `akx-subagent-acp` tests. It speaks the agent side of ACP over stdio and is
 ...
 *
 * @module @akashx/akx-subagent-acp/tests/mock-acp-server
 */
...
createAcpAgentApp({ name: 'akx-subagent-acp-test-agent' })
