...
- [Generated configuration catalog](../../../docs/config-catalog.md#akashxakx-subagent-codex) — every accepted config field and its source declaration.
