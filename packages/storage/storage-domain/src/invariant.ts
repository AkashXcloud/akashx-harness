/**
 * Package-owned invariant companion for `@akashx/akx-storage-domain`: every
 ...
 * @module @akashx/akx-storage-domain/invariant
 */
...
const PACKAGE_NAME = '@akashx/akx-storage-domain'
