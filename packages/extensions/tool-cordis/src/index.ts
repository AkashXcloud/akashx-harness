...
} from '@akashx/akx-cordis-host-runner'
import type { DynamicCordisReference } from '@akashx/akx-cordis-host-runner'
...
function renderUnavailableReference(id: string): string {
  return [
    ...
    'It may have been removed, belong to another Session, or have been lost when the AKX process restarted.',
