...
import type { InjectFace, PropsLocale } from '@akashx/akx-client-ui-slots'
...
export type CordisDefineRowProps = ToolCallViewProps & InjectFace<CordisCardFace> & PropsLocale<'@akashx/cordis'>
