 ...
 * @module @akashx/akx-cordis-host-runner/guard
 */

import { Context } from '@akashx/cordis'
import type { Plugin } from '@akashx/cordis'
import { scopeOf } from '@akashx/akx-scope'
import { assertSupportedJsonSchema, defineTool } from '@akashx/akx-tools'
...
function sandboxContext(ctx: Context, reportFailure: (error: Error) => void): Context {
  ...
  // (`@akashx/akx-cordis-client-runner`, whose CTX_VERBS names this one its
