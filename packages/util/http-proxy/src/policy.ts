 ...
 * evaluates `akx-web-fetch-http` without a Node transport.
 * @module @akashx/akx-http-proxy/policy
 */
 ...
 *
 * This is the single answer both the installed dispatcher and `akx-web-fetch-http` consult, so a URL
