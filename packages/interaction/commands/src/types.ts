 ...
 *
 * @module @akashx/akx-commands/types
 */

import type { SessionSeq } from '@akashx/akx-session/types'
import type { CommandDefinitionId, CommandId } from './brand.ts'
import type { EncodedImageAttachment } from '@akashx/akx-attachment/types'
