 ...
 *
 * The `Branded<B>` primitive lives in `@akashx/akx-brand`; this module
 ...
 * loading the host plugin's Context merges — the `akx-llm/brand` shape.
 *
 * @module @akashx/akx-commands/brand
 */
