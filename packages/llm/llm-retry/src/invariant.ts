/** Package-owned durable retry-event invariants. @module @akashx/akx-llm-retry/invariant */

import type { Context } from '@akashx/cordis'
import type { Session, SessionEvent } from '@akashx/akx-session'
import type { LlmFailure } from '@akashx/akx-llm'
...
const PACKAGE_NAME = '@akashx/akx-llm-retry'
