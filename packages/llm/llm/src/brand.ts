/**
 * akx-llm's owned branded ids: tool-call correlation and provider request
 * diagnostics.
 *
 * The `Branded<B>` primitive and stateless constructor live in
 * `@akashx/akx-brand` so every owner of a cross-boundary id can brand it
 * without depending on akx-llm; see that package's README for the
 * nominal-typing policy.
 *
 * @module @akashx/akx-llm/brand
 */
