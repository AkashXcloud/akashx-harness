...
import { APP_IDENTITY, attributionHeaders, userAgent } from '@akashx/akx-llm'
import type { AppIdentity } from '@akashx/akx-llm'
...
describe('userAgent', () => {
  it('renders product/version with the +url comment', () => {
    expect(userAgent()).toBe(
      `akx-harness/${manifest.version} (+https://github.com/akashx-ai/akx-harness)`,
    )
  })
