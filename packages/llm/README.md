---
description: "The LLM capability group: a provider-neutral model-call service, the AkashX and pi-ai provider adapters, request-retry execution, and replay-aware token measurement."
kind: "package-group"
---
...
| [`llm-akx/`](llm-akx/README.md) | Serves the `akashx-official` route with direct AkashX chat-completions, thinking, and image input | registers on `ctx.llm` |
...
| [`llm-api-extensions/`](llm-api-extensions/README.md) | Registers lifecycle-owned top-level fields on official AkashX requests | `ctx.akashxLlmApiExtensions` |
| [`plugin-package-inventory/`](plugin-package-inventory/README.md) | Contributes the active Loader package inventory to official AkashX requests | contributes `akx_plugin_packages` |
