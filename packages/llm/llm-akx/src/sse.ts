 ...
 * AkashX protocol: the literal `[DONE]` is yielded so the caller owns final
 ...
 *
 * @module akx-llm-akx/sse
 */

import { EventSourceParserStream } from 'eventsource-parser/stream'
import { LlmError } from '@akashx/akx-llm'

/** The terminal payload AkashX (and OpenAI) send after the last chunk. */
