/**
 * Translate AkashX SSE payloads with one stateful harness block per content, reasoning, or tool
 ...
 *
 * Translate AkashX wire chunks into the harness `StreamChunk` protocol.
 * @module akx-llm-akx/translate
 */

import { brandString } from '@akashx/akx-brand'
import { EMPTY_RESPONSE_CODE, LlmError } from '@akashx/akx-llm'
import type { ContentBlock, FinishReason, StreamChunk, TokenUsage, ToolCallId } from '@akashx/akx-llm'
...
/**
 * Map wire usage fields. AkashX's `prompt_tokens` INCLUDES cache hits
