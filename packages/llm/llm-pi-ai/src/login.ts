...
import type { AuthorizationMethod, AuthorizationPrompt, AuthorizationSession } from '@akashx/akx-authorization'
import { isCredentialKeySegment } from '@akashx/akx-credentials'
