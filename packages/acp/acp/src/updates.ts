/** Standard ACP updates derived from committed AKX session events. */
 ...
 * @param event - committed AKX tool-call event.
 ...
 * @param event - committed AKX tool-result event.
...
/** Report current context occupancy only when AKX has both usage and capacity facts. */
