/** Standard ACP MCP-server declarations translated into Agent-scoped AKX MCP clients. */
...
import * as McpClient from '@akashx/akx-mcp-client'
...
/** Produce a stable AKX tool namespace from ACP's human-readable server name. */
