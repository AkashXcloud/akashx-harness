...
import { installModelSelection, type ModelSelection, type ModelSelectionRef } from '@akashx/akx-agent'
import { ReasoningEffortId, type LlmCallConfig, type LlmRuntime } from '@akashx/akx-llm'

const MODEL_CONFIG_ID = 'model'
const REASONING_CONFIG_ID = 'reasoning_effort'
// AKX reasoning effort ids are non-empty, so the empty opaque ACP value is a disjoint provider-default choice.
