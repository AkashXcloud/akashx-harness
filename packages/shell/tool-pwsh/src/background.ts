 ...
 * twin of `akx-tool-bash`'s background adaptation.
 *
 * @module @akashx/akx-tool-pwsh/background
 */

import type { ShellProcess } from '@akashx/akx-shell'

/* jscpd:ignore-start -- deliberate twin of akx-tool-bash/background.ts (Agent Note). */
