 ...
 * `akx-tool-bash`'s renderer: stdout, a marked stderr section, sandbox
 ...
 * results.
 *
 * @module @akashx/akx-tool-pwsh/render
 */

import type { ShellProcessRead, ShellSandboxInfo, CollectedOutput } from '@akashx/akx-shell'
import type { SandboxMode } from '@akashx/akx-sandbox'
import { escalationHintMarker, sandboxDenialMarker } from '@akashx/akx-sandbox'

/* jscpd:ignore-start -- deliberate twin of akx-tool-bash/render.ts (Agent Note). */
