...
The generated [configuration catalog](../../../docs/config-catalog.md#akashxakx-tool-pwsh) is the exhaustive source for every accepted field and its JSDoc; the generated [tool catalog](../../../docs/tool-catalog.md#akashxakx-tool-pwsh) carries the full argument schema.
...
- [Generated tool catalog](../../../docs/tool-catalog.md#akashxakx-tool-pwsh) — the exact `pwsh` argument schema.
- [Generated configuration catalog](../../../docs/config-catalog.md#akashxakx-tool-pwsh) — every accepted config field and its source declaration.
...
The model sees the generated [`pwsh` schema](../../../docs/tool-catalog.md#akashxakx-tool-pwsh). Agent-scoped tool restrictions can remove the definition for that agent.
