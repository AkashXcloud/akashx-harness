 ...
 * @module @akashx/akx-tool-pwsh-persistent
 */
...
import type { TerminalReadResult, TerminalSendResult, TerminalSessionId } from '@akashx/akx-terminal'
...
const SHELL_PROMPT = '__AKX_PERSISTENT_PWSH_PROMPT__ '
...
function markers(): CommandMarkers {
  ...
  return {
    start: `__AKX_PERSISTENT_PWSH_START_${nonce}__`,
    end: `__AKX_PERSISTENT_PWSH_END_${nonce}:`,
  }
}
