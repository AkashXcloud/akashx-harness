 ...
 *
 * @module @akashx/akx-tool-bash/render
 */

import type { ShellProcessRead, ShellRunResult, ShellSandboxInfo, CollectedOutput } from '@akashx/akx-shell'
import type { SandboxMode } from '@akashx/akx-sandbox'
import { escalationHintMarker, sandboxDenialMarker } from '@akashx/akx-sandbox'
 ...
 * rendering story, owned by `@akashx/akx-shell` so `akx-tool-pwsh` reuses
 ...
 */
export { parseExitStatus, type ParsedExitStatus } from '@akashx/akx-shell'
