#!/usr/bin/env node
/**
 * Stable link target for the `akx-pack-vfs-image` bin, forwarding to the build
 * product.
 *
 ...
 * @module @akashx/akx-experimental-webworker-packer/bin
 */
...
if (!existsSync(fileURLToPath(entry))) {
  process.stderr.write('akx-pack-vfs-image: lib/bin.js is missing — run `pnpm run build` before packing an image\n')
  process.exit(1)
}
