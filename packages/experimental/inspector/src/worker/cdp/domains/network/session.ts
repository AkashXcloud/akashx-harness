    ...
    switch (method) {
      ...
      case 'Network.getResponseBody': {
        ...
        return {
          ...
          base64Encoded: true,
          akxInspectorTruncated: body.truncated,
          ...(body.captureError === undefined ? {} : { akxInspectorCaptureError: body.captureError }),
        }
      }
    ...
    switch (event.type) {
      ...
      case 'response-received': {
        ...
        session.sendEvent('Network.responseReceived', {
          ...
          frameId: 'akx-inspector-host-frame',
          timestamp,
          type: resourceType,
          response: {
            url: event.url,
      ...
      case 'request-finished':
        ...
        session.sendEvent('Network.loadingFinished', {
          ...
          akxInspectorTruncated: event.truncated,
        })
