...
The generated [configuration catalog](../../../docs/config-catalog.md#akashxakx-experimental-agent-team) is the exhaustive source for every accepted field and its JSDoc.
