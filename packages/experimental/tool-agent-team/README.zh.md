...
生成的[配置目录](../../../docs/config-catalog.zh.md#akashxakx-experimental-tool-agent-team)是每个受支持字段及其 JSDoc 的穷尽式真源。
...
- [生成的工具目录](../../../docs/tool-catalog.zh.md#akashxakx-experimental-tool-agent-team)——模型接收的每个工具 schema。
