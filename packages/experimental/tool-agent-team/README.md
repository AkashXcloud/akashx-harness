...
The generated [configuration catalog](../../../docs/config-catalog.md#akashxakx-experimental-tool-agent-team) is the exhaustive source for every accepted field and its JSDoc.
...
- [Generated tool catalog](../../../docs/tool-catalog.md#akashxakx-experimental-tool-agent-team) — every tool schema the model receives.
