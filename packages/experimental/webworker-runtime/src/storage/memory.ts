 ...
 * @module @akashx/akx-experimental-webworker-runtime/src/storage/memory
 */
...
// stored value — the round-trip consumers like akx-credentials-local's
 ...
 */
export function loadVfsImage(image: Uint8Array, root = '/akx', vfs = new MemoryVfs()): MemoryVfs {
