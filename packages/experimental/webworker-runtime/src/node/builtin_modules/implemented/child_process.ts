 ...
 * @module @akashx/akx-experimental-webworker-runtime/src/node/builtin_modules/implemented/child_process
 */
...
import { AKX_ROOT } from '../../../storage/paths.ts'
...
export function spawn(
  ...
  queueMicrotask(() => {
    void (async () => {
      const cwd = options.cwd ?? AKX_ROOT
