/** Package-owned compaction log-stream invariants. @module @akashx/akx-compaction/invariant */

import type { Context } from '@akashx/cordis'
import { isReplacementSurfaceEvent, SessionSeq } from '@akashx/akx-session'
import type { Session, SessionEvent } from '@akashx/akx-session'
import { SurfaceManager } from '@akashx/akx-session/surface'
...
const PACKAGE_NAME = '@akashx/akx-compaction'
