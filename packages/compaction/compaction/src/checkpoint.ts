 ...
 *
 * The seam itself lives in `@akashx/akx-compaction`, which re-exports these
 ...
 * `akx-commands/brand` shape.
 *
 * @module @akashx/akx-compaction/checkpoint
 */

import type { MessageSource } from '@akashx/akx-llm/message'
