...
/**
 * Tail script settling the boot-readiness deferred (`__AKX_BOOT_READY__`):
 ...
 */
const READY_MARKUP = '<script>(globalThis.__AKX_BOOT_READY__ ??= Promise.withResolvers()).resolve()</script>'
