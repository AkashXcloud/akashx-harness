...
# @akashx/akx-host-plugin-inventory
...
- **Presets appear only with a roster** — a deployment without `akx-agent-presets` serves Loader entries alone; the `agentPresets` field is absent rather than empty.
