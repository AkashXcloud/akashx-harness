 ...
 * @module @akashx/akx-host-directory-picker-auto
 */
...
export const BACKEND_PACKAGES: Record<DirectoryPickerBackendKind, string> = {
  native: '@akashx/akx-host-directory-picker-native',
  browse: '@akashx/akx-host-directory-picker-browse',
}
...
export const SURFACE_PACKAGES: Record<DirectoryPickerBackendKind, string> = {
  native: '@akashx/akx-client-ui-directory-picker-native',
  browse: '@akashx/akx-client-ui-directory-picker-browse',
}
