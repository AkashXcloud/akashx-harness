...
The generated [configuration catalog](../../../docs/config-catalog.md#akashxakx-credentials-local) is the exhaustive source for every accepted field and its JSDoc.
