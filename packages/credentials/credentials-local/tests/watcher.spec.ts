...
const KEY = credentialRef('AKX_CRED_PIPE')
...
async function tempDir(): Promise<string> {
  const dir = await mkdtemp(join(tmpdir(), 'akx-credentials-watch-'))
