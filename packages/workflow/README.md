...
- [Generated tool catalog](../../docs/tool-catalog.md#akashx-akx-tool-workflow) — the `workflow` tool schema the model receives.
- [Generated tool catalog](../../docs/tool-catalog.md#akashx-akx-tool-ralph) — the `ralph` tool schema the model receives.
- [Generated configuration catalog](../../docs/config-catalog.md#akashx-akx-workflow-worker-thread) — every accepted engine config field.
