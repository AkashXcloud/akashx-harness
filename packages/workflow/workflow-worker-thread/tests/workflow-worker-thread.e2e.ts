...
import * as Spawn from '@akashx/akx-subagent-spawn-in-process'
import WorkerThreadWorkflowEngine from '../src/index.ts'

/**
 * With-key e2e: a REAL script in a REAL worker thread
 * drives REAL spawn children against the live AkashX API — one plain child
...
describe.skipIf(!process.env.AKASHX_API_KEY)('worker workflow engine with-key e2e', () => {
