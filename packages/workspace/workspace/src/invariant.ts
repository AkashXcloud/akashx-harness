/**
 * Package-owned invariant companion for `@akashx/akx-workspace`.
 * @module @akashx/akx-workspace/invariant
 */
...
import { WorkspaceId } from '@akashx/akx-workspace'

const PACKAGE_NAME = '@akashx/akx-workspace'
