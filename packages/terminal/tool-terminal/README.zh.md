...
生成的[配置目录](../../../docs/config-catalog.zh.md#akashxakx-tool-terminal)与[工具目录](../../../docs/tool-catalog.zh.md#akashxakx-tool-terminal)是配置字段与 schema 的穷尽式真源。
...
- [工具目录](../../../docs/tool-catalog.zh.md#akashxakx-tool-terminal)——6 个生成的 schema 与结果形态。
...
6 个生成的 schema 列在 [`akx-tool-terminal` 目录章节](../../../docs/tool-catalog.zh.md#akashxakx-tool-terminal)中。此插件活跃时，请求中会包含它们的固定 schema token；按 agent 范围过滤工具时可能隐藏这些 schema。
