...
import { apply, inject, InputTriggerService } from '@akashx/akx-client-ui-input-trigger/client'
import type { MenuViewInjected } from '@akashx/akx-client-ui-input-trigger/client'
