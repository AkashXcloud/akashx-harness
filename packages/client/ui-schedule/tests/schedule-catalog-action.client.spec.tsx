...
import type { SessionSnapshot, UseProjection } from '@akashx/akx-api-session-controller/client'
import type { ScheduleRecord } from '@akashx/akx-schedule/client'
import { ScheduleId } from '@akashx/akx-schedule'
...
describe('ScheduleCatalogAction rows', () => {
  ...
  it('renders exact recurring units without rounding and localizes both dictionaries', () => {
    ...
    const tZh = makeTranslate(en)
    const samples = [
      [86_400, 'Every 1 day', 'Every 1 day'],
      [172_800, 'Every 2 days', 'Every  2d'],
    ...
    expect(tZh('status.scheduled')).toBe('Pending')
