/**
 * The web-search card's staged form over the `web-search-akx` settings
 * namespace.
 *
...
import type { SettingsScope, SettingsScopeSnapshot } from '@akashx/akx-client-ui-settings/client'
import {
...
/**
 * Namespace of the AkashX search provider. Spelled here rather than
 * imported: a client package must not depend on a Host package.
 */
export const WEB_SEARCH_NS = 'web-search-akx'

/** Credential reference the provider resolves when the section names none. */
const DEFAULT_API_KEY_REF = 'AKASHX_API_KEY'
...
/** Bridges the `web-search-akx` scope and the credentials domain onto the card. */
export class WebSearchCardController {
  ...
  /**
   * @param scope - the bound settings scope for the `web-search-akx` namespace.
