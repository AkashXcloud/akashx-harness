...
import type { PropsLocale, PropsRuntime, PropsStore, TranslateNS } from '@akashx/akx-client-ui-slots'
import {
...
import { fileAddressFor, pathPartsOf } from '@akashx/akx-util-workspace-path'
import type { WorkspaceDirectoryEntry } from '@akashx/akx-api-workspace-files/types'
