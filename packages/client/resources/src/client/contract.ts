 ...
 * `akx-resource://<type>/…` URL: the host names the protocol. The protocol's
 ...
 * encodes it in the path, as `akx-resource://file/session/<sessionId>/<absolute
...
import type { ResourceProtocolMap } from '@akashx/akx-client-ui-slots'
...
export interface ResourceProvider<P extends ResourceProtocol> {
   ...
   * @param address - the full address, a `akx-resource://<type>/…` URL.
