 ...
 */
import type { FloatRect, PaneId, TabId, TabRecord } from '@akashx/akx-client-ui-dockkit'
import { activeDockPaneId, canSplit, dockPaneIds, findTabPane, getPane } from '@akashx/akx-client-ui-dockkit'
import type { BoundActions } from '@akashx/akx-client-ui-slots'
...
const RESOURCE_SCHEME = 'akx-resource://'
