...
import { WorkspaceFiles } from '@akashx/akx-api-workspace-files'
...
import { SessionQueryError } from '@akashx/akx-session-query'
import type { SessionEventReadRequest } from '@akashx/akx-session-query'
...
async function fixture() {
  const root = await mkdtemp(join(tmpdir(), 'akx-present-open-'))
