...
import type { GoalActivation, GoalSnapshot } from '@akashx/akx-goal/client'
import {
...
import type { InjectFace, PropsLocale, TranslateNS } from '@akashx/akx-client-ui-slots'
...
export type GoalDockProps =
  import('@akashx/akx-client-ui-slots').PropsRuntime<'conversation.input.dock'>
