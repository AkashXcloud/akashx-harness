...
import type { ModelSelection } from '@akashx/akx-api-session-controller/types'
import type {} from '@akashx/akx-api-session-controller/client'
import type { Context as ClientContext } from '@akashx/cordis'
import type { CommandUiContract, SelectOption } from '@akashx/akx-client-ui-commands/client'
...
import { IconDataOutline16 } from '@akashx/akx-client-ui-primitives'
...
const BUILTIN_DESCRIPTION_KEYS: Readonly<Record<string, ModelKey>> = {
  'akashx-official/akashx-v4-flash': 'option.akashxV4Flash.description',
  'akashx-official/akashx-v4-pro': 'option.akashxV4Pro.description',
}
