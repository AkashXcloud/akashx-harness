...
# @akashx/akx-client-ui-model-selection
...
- [akx-agent-default-model](../../core/agent-default-model/README.md) — the default-model service for sessions that never choose.
