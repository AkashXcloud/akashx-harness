 ...
 * @module @akashx/akx-client-modules/client
 */
...
export { exactPackageSpecifier, parseBootManifest, parseAkxClient, stripClientSuffix } from './manifest.ts'
export type {
  ...
  ClientModuleSystemOptions, AkxWindow,
