...
import type { FileUploadReceiptId } from '@akashx/akx-client-file-upload/client'
...
import type { SessionPendingInteraction } from '@akashx/akx-client-ui-session/client'
