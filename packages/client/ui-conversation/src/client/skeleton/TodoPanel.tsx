...
import type { PropsLocale, PropsRuntime } from '@akashx/akx-client-ui-slots'
...
import { IconChecklistOutline14, IconChevronDownOutline14, IconChevronUpOutline14 } from '@akashx/akx-client-ui-primitives'
...
/** Local exhaustiveness helper — client packages do not depend on `akx-llm`. */
