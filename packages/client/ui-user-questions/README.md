---
description: "Web ask_user_question feature for the akx web client: the composer-takeover question UI and the plan-review approval card."
kind: "package-reference"
---

# @akashx/akx-client-ui-user-questions
...
Indirectly, through `akx-tool-ask-user`, whose model-visible schema and answer rendering this package presents in the Web client.

#### KV Cache effect

No direct invalidation; `akx-tool-ask-user` owns the model-visible tool call and result.
