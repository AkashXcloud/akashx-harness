...
import { apply, inject, SETTINGS_NS } from '@akashx/akx-client-ui-theme/client'
import type { AppearanceRowInjected, FontSizeRowInjected, ThemeRuntime } from '@akashx/akx-client-ui-theme/client'
...
async function bench(isLoopback = true) {
  ...
  events.$host = { home: undefined, isLoopback, isPrivileged: isLoopback }
