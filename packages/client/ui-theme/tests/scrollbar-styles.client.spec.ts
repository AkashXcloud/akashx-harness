...
const INDIRECTION_PREFIX = '--akx-scrollbar-'
...
const ELEVATED_REBIND = new Map([
  ['--akx-scrollbar-thumb', '--dsw-alias-scrollbar-bg-l2'],
  ['--akx-scrollbar-thumb-hover', '--dsw-alias-scrollbar-hover-l2'],
...
describe('scrollbar.css geometry variables', () => {
  ...
  it('every reader of the width variable outside ui-theme references a defined variable', () => {
    ...
    // (`right: var(--akx-scrollbar-width)`); a rename in scrollbar.css without
