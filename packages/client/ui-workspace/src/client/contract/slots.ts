 ...
 */
import type { HostObservable, PropsHooks, PropsLocale, PropsRenderSlots, PropsRuntime, PropsStore } from '@akashx/akx-client-ui-slots'
...
import type { SessionSearchResultItem } from '@akashx/akx-api-session-controller/client'
import type { RemoteHostFacts } from '@akashx/akx-api-remotes/client'
...
export type WorkspaceBrowserInjected = {
  ...
  /** Permanently delete a Session and its stored log. */
