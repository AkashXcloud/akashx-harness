...
export function WorkspaceBrowser({
  ...
  const openSessionDelete = (sessionId: SessionId, title: string) => {
          ...
          : groupBy === 'flat'
            ? (
              <FlatList
                ...
                onSessionRename={onSessionRename} onSessionArchive={onSessionArchive} onSessionDelete={openSessionDelete}
                archivedSessionIds={archivedSessionIds}
                orderBy={orderBy}
