...
import { SlotTestRuntime, TestRemote, usePinnedBrowserLanguages } from '@akashx/akx-client-test-runtime'
...
describe('Host home in the assembled browsing region', () => {
  it('abbreviates the path once a home learned after first render reaches the rows', async () => {
    ...
    remote.$host = { home: undefined, isLoopback: true, isPrivileged: true }
    runtime.renderRoot()
    vi.useFakeTimers()
    try {
      openHoverCard()
      ...
      remote.$host = { home: '/home/u', isLoopback: true, isPrivileged: true }
