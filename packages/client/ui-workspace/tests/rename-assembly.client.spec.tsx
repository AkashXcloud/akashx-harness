...
import { RemoteError, SlotTestRuntime, TestRemote, usePinnedBrowserLanguages } from '@akashx/akx-client-test-runtime'
import { LocaleRuntime } from '@akashx/akx-client-locale/client'
import { apply, inject } from '@akashx/akx-client-ui-workspace/client'
...
/** Runtime with the locale face installed (the browser entry declares `locale:` — en default backs the t seat). */
