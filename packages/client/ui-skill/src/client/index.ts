 ...
 * determinism
 * lives host-side — the pre-step boundary (`akx-tool-skill`) recognizes a
...
import type { SkillEntry } from '@akashx/akx-api-remotes/client'
import type {} from '@akashx/akx-api-session-controller/client'
import type { SessionId } from '@akashx/akx-session/types'
import type { InputTriggerServiceContract, InputTriggerSource } from '@akashx/akx-client-ui-input-trigger/client'
import { fileAddressFor } from '@akashx/akx-util-workspace-path'
import { rankByName } from '@akashx/akx-client-ui-primitives'
...
export function apply(ctx: ClientContext): void {
  ...
  const source: InputTriggerSource = {
    ...
    onPick({ candidate }) {
      ...
      // pre-step boundary (akx-tool-skill) recognizes the leading /name and
