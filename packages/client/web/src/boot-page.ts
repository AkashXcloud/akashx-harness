 ...
 * @module @akashx/akx-client-web/src/boot-page
 */
...
export class BootPage {
  ...
  constructor(container: HTMLElement) {
    ...
    this.root.dataset.akxBoot = ''
    this.card = div(css.card)
    this.wordmark = div(css.wordmark, 'HARNESS')
    this.spinner = div(css.spinner)
    this.spinner.dataset.akxBootSpinner = ''
  ...
  private updateProgress(): void {
    ...
    this.spinner.style.setProperty('--akx-boot-arc', `${String(Math.round(72 + ratio * 216))}deg`)
  }
}
