...
import type { PropsRenderSlots, TranslateNS } from '@akashx/akx-client-ui-slots'
import type { OpenFileOptions } from '@akashx/akx-client-ui-chat/client'
import type { MessageImageLoader } from '@akashx/akx-client-ui-conversation/client'
                  ...
                  : imageBody !== null
                    ...
                    : searchBody !== null
                      ...
                      : webBody !== null
                        ...
                        : chartBody !== null
                          ? <ChartCard model={chartBody} label={t('row.output')} />
                          : (
                            <>
