...
import type { AttachmentId, ImageAttachmentRef, ImageMediaType } from '@akashx/akx-attachment'
 ...
 *  Hand-written mirror of `ImageMediaType` from akx-attachment — the wire
