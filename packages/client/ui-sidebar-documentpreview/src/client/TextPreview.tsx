...
import type { InjectFace, PropsLocale, PropsRenderSlots, PropsRuntime, PropsStore } from '@akashx/akx-client-ui-slots'
import { FileTypeIcon, IconRefreshOutline16, Menu, Tooltip, classifyFileType } from '@akashx/akx-client-ui-primitives'
import { pathPartsOf } from '@akashx/akx-util-workspace-path'
