 ...
 * session and a workspace path while a tab carries a `akx-resource://file/`
...
import type { WorkspaceFileBytes, WorkspaceFileRange, WorkspaceFileText } from '@akashx/akx-api-workspace-files/types'
...
/**
 * The session and path one `akx-resource://file/…` address names.
 *
 ...
 * @param address - a tab's `akx-resource://file/…` address.
