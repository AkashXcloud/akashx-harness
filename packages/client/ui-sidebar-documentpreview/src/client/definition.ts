 ...
 *
 * The type claims every `akx-resource://file/session/<sessionId>/<path>`
 ...
 */
import type { SidebarRightTabDefinition } from '@akashx/akx-client-ui-sidebar-right/client'
...
export const TEXTPREVIEW_ID = '@akashx/akx-client-ui-sidebar-documentpreview'
