...
import type { PropsRuntime, SlotHookFactory } from '@akashx/akx-client-ui-slots'
import type { UseSidebarRightTabInfo } from '@akashx/akx-client-ui-sidebar-right/client'
