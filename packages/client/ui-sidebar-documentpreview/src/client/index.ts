...
import type {} from '@akashx/akx-api-workspace-files/remote'
import type { WorkspaceFileParams } from '@akashx/akx-api-workspace-files/client'
...
declare module '@akashx/akx-client-ui-sidebar-right/client' {
