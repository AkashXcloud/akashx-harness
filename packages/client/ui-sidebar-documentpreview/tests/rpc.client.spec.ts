/**
 * The address-to-read translation: a `akx-resource://file/session/<id>/<path>`
...
describe('hostFileOf', () => {
  it('reads the session and the decoded relative path out of a session file address', () => {
    ...
    expect(hostFileOf('akx-resource://file/session/s%2F1/work/a%20b%23c.md')).toEqual({ sessionId: 's/1', path: 'work/a b#c.md' })
  })
  ...
  it('throws for an address that is not a Session file address', () => {
    for (const address of [
      'akx-resource://file/absolute/etc/hosts', 'akx-resource://file/absolute/C:/w/a.md',
      'akx-resource://file/shared/team/notes.md', 'akx-resource://file/session', 'file:///work/notes.md', 'sidebar://guide',
    ]) {
