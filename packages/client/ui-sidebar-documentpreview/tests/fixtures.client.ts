...
import type { RemoteFailure, RemoteResult } from '@akashx/akx-api-remotes/client'
import type { ResourceSnapshot } from '@akashx/akx-client-resources/client'
import type { SessionId } from '@akashx/akx-session/types'
import type { WorkspaceFileStat, WorkspaceFileText } from '@akashx/akx-api-workspace-files/types'
...
export const ADDRESS = 'akx-resource://file/session/s-1/work/notes.md'
