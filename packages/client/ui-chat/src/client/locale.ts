...
export const en = {
  ...
  'message.turnUsage.working': 'Working',
  'stats.dialog.databaseTitle': 'Database spend',
  'stats.dialog.databaseTokens': 'Database tokens',
  'stats.dialog.databaseTime': 'Database time',
  'stats.dialog.databaseCalls': 'Cognitive calls',
  'stats.databaseShort': '{count} db',
