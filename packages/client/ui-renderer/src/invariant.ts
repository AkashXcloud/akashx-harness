/**
 * Package-owned invariant companion for `@akashx/akx-client-ui-renderer`.
 * @module @akashx/akx-client-ui-renderer/invariant
 */
...
import type { SlotMap } from '@akashx/akx-client-ui-slots'
import type { InvariantInstaller } from '@akashx/akx-invariants'

const PACKAGE_NAME = '@akashx/akx-client-ui-renderer'
