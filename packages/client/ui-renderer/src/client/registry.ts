...
import { SlotCore, standardHookPropName } from '@akashx/akx-client-ui-slots'
import type {
...
export class SlotRegistry extends Service {
  ...
  private rebuildRootBinding(): void {
    ...
    const keyedHooks: Record<string, import('@akashx/akx-client-ui-slots').KeyedStandardSource> = {}
