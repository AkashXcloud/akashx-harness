...
import { apply, inject } from '@akashx/akx-client-locale/client'
import type { LocaleRuntime } from '@akashx/akx-client-locale/client'
...
describe('document language', () => {
  beforeEach(() => {
    ...
    Object.defineProperty(navigator, 'languages', { value: ['fr-CA'], configurable: true })
