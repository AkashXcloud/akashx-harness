...
import { SettingsSchemaService } from '@akashx/akx-client-ui-settings/src/client/schema.ts'
import { SettingsDescribeMirror } from '@akashx/akx-client-ui-settings/src/client/settings-mirror.ts'
import { SettingsScopeController } from '@akashx/akx-client-ui-settings/src/client/settings-scope.ts'
...
const WELCOME_NOTICE_COPY = { title: en.welcomeTitle, body: en.welcomeBody, continueLabel: en.welcomeContinue }
...
describe('WelcomeNotice', () => {
  it('uses the exact owner copy', () => {
    expect(WELCOME_NOTICE_COPY).toEqual({
      ...
      body: "AkashX Harness 0.1 remains in testing for Harness developers. Many areas need further improvement, and we welcome feedback from the developer community. AkashX Harness's core plugins and foundational APIs will continue to evolve rapidly over the coming months.\n\nWe look forward to exploring the limits of intelligence with developers around the world, building on open-source, open, reusable, and composable infrastructure. We welcome Harness developers everywhere to join the AKX plugin ecosystem.",
