 ...
 * @module @akashx/akx-client-ui-settings-models/apiKey
 */

/**
 * Twin of `normalizeApiKey` in `@akashx/akx-llm`: printable ASCII, space
 ...
 * `validateAkashXModels` is kept in step with the host's `catalogModel`.
 */
