...
export const en = {
  ...
  welcomeBody: 'AkashX Harness runs agents over AkashXDB and the tools you mount, with Cognitive SQL as its query surface. The plugin API and the foundational capabilities behind it are pre-stable and will keep evolving.\n\nConfigure a model provider to begin. Providers, tools, and plugins are composable: mount the ones this deployment needs.',
  welcomeContinue: 'Continue',
  welcomeError: 'The acknowledgement could not be saved. Please try again.',
  onboardingTitle: 'Add an API key to get started',
  onboardingDescription: 'Configure a model provider to start building.',
