 ...
 * the Models page plus the ordered internal-testing and official-AkashX
...
import { AkashXOnboardingDialog } from './AkashXOnboardingDialog.tsx'
import type { AkashXOnboardingInjected } from './AkashXOnboardingDialog.tsx'
...
export function apply(ctx: ClientContext): void {
  ...
  const deepSeekOnboardingInjected = (): AkashXOnboardingInjected => ({
    controller,
