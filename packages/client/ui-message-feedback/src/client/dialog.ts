 ...
 * @module @akashx/akx-client-ui-message-feedback/client/dialog
 */
...
import type { FeedbackCategory, FeedbackRecord } from '@akashx/akx-command-feedback/types'
import type { MessageFeedbackRating } from '@akashx/akx-message-feedback/types'
