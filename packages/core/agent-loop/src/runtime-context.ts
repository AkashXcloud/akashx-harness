 ...
 * @module @akashx/akx-agent-loop/runtime-context
 */

import { createSystemMessage, createUserMessage } from '@akashx/akx-llm'
import type { ContextSnapshotSection, Message } from '@akashx/akx-llm'
import type { Session, SessionEvent, SessionSeq, SurfaceIntent, SystemMessage, UserMessage } from '@akashx/akx-session'
import { isReplacementSurfaceEvent } from '@akashx/akx-session'
import type { Context } from '@akashx/cordis'

const SOURCE = '@akashx/akx-system-prompt'
