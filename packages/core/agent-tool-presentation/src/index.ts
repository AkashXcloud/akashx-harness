 ...
 * ([`akx-code-runtime-worker-thread`](../../code-runtime/code-runtime-worker/README.md)).
 ...
 * @module @akashx/akx-agent-tool-presentation
 */

import type { Context } from '@akashx/cordis'
import z from '@akashx/schemastery'
import type { ToolPresentationMode } from '@akashx/akx-tools'
...
export function apply(ctx: Context, config: Config): void {
  ...
  // what `akx-agent-presets` reports as an unusable row, naming this id.
