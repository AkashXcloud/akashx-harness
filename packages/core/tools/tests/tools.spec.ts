...
import LlmRuntime, { createUserMessage, ToolCallId, HarnessError, type ContentBlock  } from '@akashx/akx-llm'
import SessionStore, { Session, SessionId } from '@akashx/akx-session'
...
import ApprovalService, { type ApprovalOutcome, type ApprovalRequest } from '@akashx/akx-user-approval'
import ToolRuntime, {
...
describe('ToolRuntime', () => {
  ...
  it('ToolNotFoundError carries a stable message and code', async () => {
    const { HarnessError } = await import('@akashx/akx-llm')
