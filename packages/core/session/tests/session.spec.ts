...
import { createSystemMessage, createUserMessage, ToolCallId, createMessage, createToolResultMessage, MessageId, ReasoningEffortId } from '@akashx/akx-llm'
import SessionStore, {
  adoptSessionEvent,
...
import type { CreateSessionOptions, SessionEventType, SessionHeader, SessionSurface } from '@akashx/akx-session'
  ...
  it('adopts a system/message by freezing its message', () => {
    const event = {
      ...
      data: {
        turn: 1,
        step: 1,
        message: createSystemMessage('You are terse.', '@akashx/akx-system-prompt'),
      },
    } as unknown as SessionEvent
