 ...
 * companion beside `@akashx/akx-invariants` to enable the checks.
 *
 * @module @akashx/akx-session/invariant
 */
...
import type { Session, SessionEvent, SessionSeqCursor } from '@akashx/akx-session'
import { assertNever } from '@akashx/akx-util-values'
import { TOOL_NOT_STARTED } from './repair.ts'

const PACKAGE_NAME = '@akashx/akx-session'
