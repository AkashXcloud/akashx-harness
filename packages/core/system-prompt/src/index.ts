 ...
 *
 * @module @akashx/akx-system-prompt
 */

import { Context, Service } from '@akashx/cordis'
import z from '@akashx/schemastery'
import { AnonymousEntries, NamedEntries, ScopedLayers, scopeTarget } from '@akashx/akx-scope'
import type { ScopeKey, ScopeLayer, Scoped } from '@akashx/akx-scope'
import type { ContextSnapshotSection, ToolSchema } from '@akashx/akx-llm'
...
declare module '@akashx/cordis' {
  ...
  interface Events {
     ...
     * Scope-filtered dispatch (`@akashx/akx-scope`): scoped listeners
  ...
  constructor(ctx: Context, config: Config) {
    ...
    if (config.includeHarnessIdentity ?? true) {
      this.section({
        ...
        text: 'You are an AI agent powered by AkashX Harness.',
      })
    }
    this.section({
