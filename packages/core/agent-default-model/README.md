...
- [Generated configuration catalog](../../../docs/config-catalog.md#akashxakx-agent-default-model) — every accepted config field and its source declaration.
