 ...
 * model-facing render consumes ({@link module:@akashx/akx-tool-fs-search/search-core}
 ...
 * final output budget (`akx-spill-policy`) only shrinks `content`, never `meta`,
 * so this projection owns keeping `meta` bounded.
 *
 * @module @akashx/akx-tool-fs-search/presentation
 */
 ...
 * ({@link module:@akashx/akx-tool-fs-search/grep} `formatGrepMatches`), so
