/** Shared top-level-call post-policy selection for search result spill. @module akx-tool-fs-search/direct-call */

import type { Context } from '@akashx/cordis'
import type { PostToolDecision, ToolDefinition, ToolExecution, ToolExecutionResult } from '@akashx/akx-tools'
