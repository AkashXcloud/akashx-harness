 ...
 * @module @akashx/akx-tool-fs/src/write
 */

import type { Context } from '@akashx/cordis'
import { defineTool } from '@akashx/akx-tools'
import type { DiffCallView, DiffResultView, ToolResult } from '@akashx/akx-tools'
import type { FsWriteOutcome } from '@akashx/akx-fs'
