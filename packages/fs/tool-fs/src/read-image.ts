 ...
 * @module @akashx/akx-tool-fs/src/read-image
 */

import { basename, extname } from 'node:path'
import type { Context } from '@akashx/cordis'
import { AttachmentError, AttachmentId } from '@akashx/akx-attachment'
import type { AttachmentStore, ImageAttachmentRef, ImageMediaType } from '@akashx/akx-attachment'
import type { ContentBlock } from '@akashx/akx-llm'
import { defineTool } from '@akashx/akx-tools'
import type { GenericCallView, ToolExecution } from '@akashx/akx-tools'
