 ...
 * @module @akashx/akx-session-projection-cache/src/spec
 */

import { z } from 'zod'
import { SessionLogOffset, SessionSeq } from '@akashx/akx-session'
import type { SessionId, SessionSeqCursor } from '@akashx/akx-session'
import { defineDomain, domainTable } from '@akashx/akx-storage-domain'
