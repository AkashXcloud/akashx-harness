 ...
 * @module @akashx/akx-session-title
 */

import { Context, FiberState, Service, type Fiber } from '@akashx/cordis'
import z from '@akashx/schemastery'
import { z as zod } from 'zod'
import type { ZodType } from 'zod'
import type { Branded } from '@akashx/akx-brand'
import { isAgentLoopRequest } from '@akashx/akx-llm'
import type { GenerateOptions } from '@akashx/akx-llm'
import { assertNever, deepFreeze } from '@akashx/akx-util-values'
import type {
  Session,
  SessionEvent,
