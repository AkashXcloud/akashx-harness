 ...
 * @module @akashx/akx-session-persistence
 */

import { Context, Service } from '@akashx/cordis'
import type { SessionEvent, SessionHeader, SessionId, SessionLogOffset } from '@akashx/akx-session'
import type { SessionHandle, SessionAccess } from './handle.ts'
import type { SessionPersistenceRevision } from './revision.ts'

// Re-export the metadata vocabulary so Consumers import it from the Service Definition.
export type { SessionHeader } from '@akashx/akx-session'
