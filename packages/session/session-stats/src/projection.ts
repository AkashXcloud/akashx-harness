 ...
 * (`deriveStats` in akx-client-ui-conversation, that fold's whole-window
 ...
 *
 * @module @akashx/akx-session-stats/projection
 */

import { z } from 'zod'
import { assistantStreamFirstTokenTime } from '@akashx/akx-llm'
