 ...
 * @module @akashx/akx-session-persistence-jsonl
 */
...
import { SESSION_FORMAT_VERSION, SessionId as makeSessionId, SessionLogOffset } from '@akashx/akx-session'
import type { SessionEvent, SessionId, SessionHeader, SessionLogOffset as SessionLogOffsetType } from '@akashx/akx-session'
import {
